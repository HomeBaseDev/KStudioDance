...
$newsletter_default_options_main['sender_name'] = get_option('blogname');
$newsletter_default_options_main['sender_email'] = get_option('admin_email');
$newsletter_default_options_main['return_path'] = get_option('admin_email');
$newsletter_default_options_main['test_email_0'] = get_option('admin_email');
$newsletter_default_options_main['test_name_0'] = 'Test Subscriber';

// Labels
$newsletter_default_options_i18n['form_name'] = 'Your name';
$newsletter_default_options_i18n['form_email'] = 'Your email';
$newsletter_default_options_i18n['form_submit'] = 'Subscribe now';
...
$newsletter_default_options_i18n['profile_submit'] = 'Update';
?>
